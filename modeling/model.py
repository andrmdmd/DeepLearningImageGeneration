...
class ConformerBlock(nn.Module):
    def __init__(
        self, d_model, n_heads, ff_expansion=4, conv_kernel_size=31, dropout=0.1
    ):
        super().__init__()
...
class ConformerClassifierScratch(nn.Module):
    def __init__(
        self,
        input_dim=80,
        d_model=144,
...
class TCNNModel(nn.Module):
    def __init__(
        self, n_input, n_output, n_channel, num_blocks, kernel_size, dropout=0.1
    ):
